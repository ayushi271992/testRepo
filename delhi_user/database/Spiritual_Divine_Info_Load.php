...
while($row=mysqli_fetch_array($result,MYSQLI_ASSOC))
	{
			...
			'Spiritual_Divine_Image_Url1'=>$row['Spiritual_Divine_Image_Url1'],
			'Spiritual_Divine_Image_Url2'=>$row['Spiritual_Divine_Image_Url2'],
			'Spiritual_Divine_Image_Url3'=>$row['Spiritual_Divine_Image_Url3'],
